      ...
      <div className={`bg-[#121212] border ${isVip ? 'border-amber-400' : 'border-gray-800'} rounded-xl shadow-2xl w-full max-w-sm m-4 p-8 text-center relative overflow-hidden`} onClick={e => e.stopPropagation()}>
        ...
        <div className="mt-8 flex flex-col gap-3 relative z-10">
          <button
            ...
            className={`w-full font-bold py-3 px-4 rounded-lg transition-transform duration-200 hover:scale-105 ${isVip ? 'bg-amber-400 text-black hover:bg-amber-300' : 'bg-white text-black hover:bg-gray-200 text-white'}`}
          >
            View in My Plans
          </button>
          <button
