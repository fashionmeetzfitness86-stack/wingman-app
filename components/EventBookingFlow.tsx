                ...
                <div className="bg-[#121212] border border-gray-800 rounded-xl shadow-2xl w-full max-w-lg m-4 relative flex flex-col max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="p-4 border-t border-gray-800 bg-black/30 rounded-b-xl">
                        ...
                        <button 
                            ...
                            className="w-full bg-white text-black hover:bg-gray-200 text-white font-bold py-3 px-4 rounded-lg transition-transform duration-200 hover:scale-[1.02] hover:bg-[#E5E5E5] disabled:bg-gray-700 disabled:cursor-not-allowed disabled:hover:scale-100"
                        >
