  ...
  return (
    <div className="p-4 md:p-8 animate-fade-in text-white pb-24">
        ...
        <div className="relative mb-8">
            <input type="search" placeholder="Search for help" className="w-full bg-gray-800 border border-gray-700 text-white rounded-lg p-3 pl-10 focus:ring-2 focus:ring-[#FFFFFF] focus:border-[#FFFFFF]" aria-label="Search for help articles" />
