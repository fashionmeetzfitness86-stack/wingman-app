          ...
          <>
            <div className="flex-grow overflow-y-auto px-4 py-4 space-y-3 no-scrollbar">
              {cartItems.map(item => {
                ...
                const isDeposit = isYacht && item.paymentOption === 'deposit';
                const price = isDeposit ? item.depositPrice : item.fullPrice;
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-baseline gap-1">
                        ...
                        {isDeposit && (
                          <span className="text-[10px]" style={{ color: 'rgba(0,212,255,0.6)' }}>/ ${item.fullPrice?.toLocaleString()} full</span>
                        )}
                      </div>
                    </div>
                  </div>
