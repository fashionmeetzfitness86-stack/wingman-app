...
// Real admin users only — fake/demo seed users removed
...
// Token transactions — starts empty for real users
...
// Notifications — starts empty; real notifications are generated by user actions
...
// Wingman applications — starts empty; real applicants submit via the application form
